...
import hu.vibe.homework.hello.infrastructure.entity.OrderItemEntity;
...
public interface OrderMapper {
    ...
    default Order toDomain(OrderEntity entity) {
        ...
        var items = entity.getItems() == null ? List.<OrderItem>of() : new java.util.ArrayList<OrderItem>(entity.getItems().stream().map(itemMapper::toDomain).toList());
